...
pub(crate) fn standard_biped_boxes(pose: BipedPose, delta: f32) -> Vec<LivingModelBox> {
    vec![
        ...
        model_box([40, 16], [-3.0, -2.0, -2.0], [4, 12, 4], delta, false, pose.rightArm, LivingModelGroup::Body),
        model_box([40, 16], [-1.0, -2.0, -2.0], [4, 12, 4], delta, true, pose.leftArm, LivingModelGroup::Body),
        model_box([0, 16], [-2.0, 0.0, -2.0], [4, 12, 4], delta, false, pose.rightLeg, LivingModelGroup::Body),
        model_box([0, 16], [-2.0, 0.0, -2.0], [4, 12, 4], delta, true, pose.leftLeg, LivingModelGroup::Body),
    ]
}
...
pub(crate) const fn model_box(
    ...
    LivingModelBox {
        texture, origin, size, delta, mirror, pose, group,
        parentPose: None, parentPose2: None, parentPose3: None, parentPose4: None,
        poseOffset: [0.0; 3], parentOffset: [0.0; 3], parentOffset2: [0.0; 3],
        parentOffset3: [0.0; 3], parentOffset4: [0.0; 3],
        childTransform: None,
    }
}
