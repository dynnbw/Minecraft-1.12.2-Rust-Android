...
impl ModelBoat {
    ...
    pub fn buildMesh(rowingTime: [f32; 2]) -> VehicleModelMesh {
        ...
        for spec in Self::sideBoxes() { append_box(&mut mesh, spec); }
        for paddle in 0..2 {
            ...
            if paddle == 1 { rotationY = std::f32::consts::PI - rotationY; }
            let texture = if paddle == 0 { [62, 0] } else { [62, 20] };
            let pivot = if paddle == 0 { [3.0, -5.0, 9.0] } else { [3.0, -5.0, -9.0] };
    ...
    pub fn buildNoWaterMesh() -> VehicleModelMesh {
        let mut mesh = VehicleModelMesh::default();
        append_box(&mut mesh, VehicleBox {
            texture: [0, 0], textureSize: Self::TEXTURE_SIZE,
            origin: [-14.0, -9.0, -3.0], size: [28, 16, 3],
            pivot: [0.0, -3.0, 1.0],
    ...
    fn sideBoxes() -> [VehicleBox; 5] {
        [
            VehicleBox { texture: [0, 0], textureSize: Self::TEXTURE_SIZE, origin: [-14.0, -9.0, -3.0], size: [28, 16, 3], pivot: [0.0, 3.0, 1.0], rotation: [std::f32::consts::FRAC_PI_2, 0.0, 0.0] },
            VehicleBox { texture: [0, 19], textureSize: Self::TEXTURE_SIZE, origin: [-13.0, -7.0, -1.0], size: [18, 6, 2], pivot: [-15.0, 4.0, 4.0], rotation: [0.0, std::f32::consts::PI * 1.5, 0.0] },
            VehicleBox { texture: [0, 27], textureSize: Self::TEXTURE_SIZE, origin: [-8.0, -7.0, -1.0], size: [16, 6, 2], pivot: [15.0, 4.0, 0.0], rotation: [0.0, std::f32::consts::FRAC_PI_2, 0.0] },
            VehicleBox { texture: [0, 35], textureSize: Self::TEXTURE_SIZE, origin: [-14.0, -7.0, -1.0], size: [28, 6, 2], pivot: [0.0, 4.0, -9.0], rotation: [0.0, std::f32::consts::PI, 0.0] },
            VehicleBox { texture: [0, 43], textureSize: Self::TEXTURE_SIZE, origin: [-14.0, -7.0, -1.0], size: [28, 6, 2], pivot: [0.0, 4.0, 9.0], rotation: [0.0, 0.0, 0.0] },
        ]
    }
}
