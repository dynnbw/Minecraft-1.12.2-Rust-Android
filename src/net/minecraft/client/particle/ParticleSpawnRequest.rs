...
impl ParticleSpawnRequest {
    pub const fn new(particleType:EnumParticleTypes,position:[f64;3],speed:[f64;3],parameters:[i32;2])->Self{
        Self{particleType,position,speed,parameters,ignoreRange:particleType.shouldIgnoreRange(),alwaysRender:false}
    }
