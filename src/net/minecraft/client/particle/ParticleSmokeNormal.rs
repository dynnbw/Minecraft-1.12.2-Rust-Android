...
impl ParticleSmokeNormal {
    pub fn new(x: f64, y: f64, z: f64, xSpeed: f64, ySpeed: f64, zSpeed: f64, scale: f32, random: &mut impl Rng) -> Self {
        ...
        Self { particle, smokeParticleScale }
    }
    pub fn renderScale(&self, partialTicks: f32) -> f32 {
        let f = (((self.particle.particleAge as f32 + partialTicks) / self.particle.particleMaxAge.max(1) as f32) * 32.0).clamp(0.0, 1.0);
