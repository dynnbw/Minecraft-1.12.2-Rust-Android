...
pub const REGISTERED_ITEM_MODELS: &[(i16, i16, &str, &str)] = &[
    ...
    (147, 0, "minecraft:light_weighted_pressure_plate", "inventory"), // minecraft:light_weighted_pressure_plate
    (148, 0, "minecraft:heavy_weighted_pressure_plate", "inventory"), // minecraft:heavy_weighted_pressure_plate
    ...
    (159, 1, "minecraft:orange_stained_hardened_clay", "inventory"), // minecraft:stained_hardened_clay
    (159, 2, "minecraft:magenta_stained_hardened_clay", "inventory"), // minecraft:stained_hardened_clay
    (159, 3, "minecraft:light_blue_stained_hardened_clay", "inventory"), // minecraft:stained_hardened_clay
    (159, 4, "minecraft:yellow_stained_hardened_clay", "inventory"), // minecraft:stained_hardened_clay
    ...
    (159, 8, "minecraft:silver_stained_hardened_clay", "inventory"), // minecraft:stained_hardened_clay
    (159, 9, "minecraft:cyan_stained_hardened_clay", "inventory"), // minecraft:stained_hardened_clay
    (159, 10, "minecraft:purple_stained_hardened_clay", "inventory"), // minecraft:stained_hardened_clay
    (159, 11, "minecraft:blue_stained_hardened_clay", "inventory"), // minecraft:stained_hardened_clay
    (159, 12, "minecraft:brown_stained_hardened_clay", "inventory"), // minecraft:stained_hardened_clay
    (159, 13, "minecraft:green_stained_hardened_clay", "inventory"), // minecraft:stained_hardened_clay
    (159, 14, "minecraft:red_stained_hardened_clay", "inventory"), // minecraft:stained_hardened_clay
    (159, 15, "minecraft:black_stained_hardened_clay", "inventory"), // minecraft:stained_hardened_clay
    ...
    (160, 3, "minecraft:light_blue_stained_glass_pane", "inventory"), // minecraft:stained_glass_pane
    ...
    (238, 0, "minecraft:light_blue_glazed_terracotta", "inventory"), // minecraft:light_blue_glazed_terracotta
...
pub fn registeredItemModels() -> impl Iterator<Item = &'static (i16, i16, &'static str, &'static str)> {
...
mod tests {
    ...
    fn table_is_sorted_and_contains_mcp_metadata_variants() {
        assert!(REGISTERED_ITEM_MODELS.windows(2).all(|pair| (pair[0].0, pair[0].1) < (pair[1].0, pair[1].1)));
    ...
    fn damageable_items_fall_back_to_metadata_zero() {
        let stack = ItemStack { itemId: 257, count: 1, itemDamage: 37, tagCompound: None };
        assert_eq!(ItemModelMesher::getModelLocation(&stack).unwrap().getPath(), "iron_pickaxe");
    }
}
