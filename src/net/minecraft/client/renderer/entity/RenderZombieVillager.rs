...
impl RenderZombieVillager {
    pub fn supports(entityType: MobEntityType) -> bool { entityType.registryName == "zombie_villager" }
    ...
    pub fn allTextures() -> [ResourceLocation; 6] {
        [
            ResourceLocation::new("minecraft", "textures/entity/zombie_villager/zombie_villager.png"),
            ResourceLocation::new("minecraft", "textures/entity/zombie_villager/zombie_farmer.png"),
            ResourceLocation::new("minecraft", "textures/entity/zombie_villager/zombie_librarian.png"),
            ResourceLocation::new("minecraft", "textures/entity/zombie_villager/zombie_priest.png"),
            ResourceLocation::new("minecraft", "textures/entity/zombie_villager/zombie_smith.png"),
            ResourceLocation::new("minecraft", "textures/entity/zombie_villager/zombie_butcher.png"),
        ]
    }
}
