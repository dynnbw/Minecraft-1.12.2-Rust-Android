...
impl RenderWitch {
    pub fn supports(entityType: MobEntityType) -> bool { entityType.registryName == "witch" }
    pub fn texture() -> ResourceLocation { ResourceLocation::new("minecraft", "textures/entity/witch.png") }
