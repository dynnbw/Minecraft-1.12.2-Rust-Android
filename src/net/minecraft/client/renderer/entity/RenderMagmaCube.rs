...
impl RenderMagmaCube {
    pub fn supports(entityType: MobEntityType) -> bool { entityType.registryName == "magma_cube" }
    pub fn texture() -> ResourceLocation { ResourceLocation::new("minecraft", "textures/entity/slime/magmacube.png") }
    pub fn interpolatedSquish(entity:&EntityOtherClient,partialTicks:f32)->f32 {
        (entity.prevSquishFactor+(entity.squishFactor-entity.prevSquishFactor)*partialTicks.clamp(0.0,1.0)).max(0.0)
    }
