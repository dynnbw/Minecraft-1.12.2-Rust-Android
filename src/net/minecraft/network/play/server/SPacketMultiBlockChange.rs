...
use crate::net::minecraft::network::PacketBuffer::{read_i32_be,read_u16_be,read_var_i32,CodecError};
use crate::net::minecraft::util::math::BlockPos::BlockPos;

#[derive(Debug,Clone,Copy,PartialEq,Eq)]
pub struct BlockUpdateData{offset:u16,blockState:IBlockState,chunkX:i32,chunkZ:i32}
impl BlockUpdateData{
    pub const fn getOffset(&self)->u16{self.offset}
...
pub struct SPacketMultiBlockChange{chunkX:i32,chunkZ:i32,changedBlocks:Vec<BlockUpdateData>}
impl SPacketMultiBlockChange{
    pub fn readPacketData(packet:&RawPacket)->Result<Self,CodecError>{
        ...
        for _ in 0..count{
            ...
            changedBlocks.push(BlockUpdateData{offset,blockState,chunkX,chunkZ});
        }
        if !input.is_empty(){return Err(CodecError::InvalidData(format!("{} trailing MultiBlockChange bytes",input.len())));}
        Ok(Self{chunkX,chunkZ,changedBlocks})
    }
    pub fn getChangedBlocks(&self)->&[BlockUpdateData]{&self.changedBlocks}
