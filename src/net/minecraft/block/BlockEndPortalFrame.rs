...
impl BlockEndPortalFrame {
    ...
    pub const AABB_BLOCK: AxisAlignedBB = AxisAlignedBB { min_x: 0.0, min_y: 0.0, min_z: 0.0, max_x: 1.0, max_y: 0.8125, max_z: 1.0 };
    pub const AABB_EYE: AxisAlignedBB = AxisAlignedBB { min_x: 0.3125, min_y: 0.8125, min_z: 0.3125, max_x: 0.6875, max_y: 1.0, max_z: 0.6875 };
    ...
    pub const fn getBoundingBox() -> AxisAlignedBB { Self::AABB_BLOCK }
...
mod tests {
    ...
    fn metadata_matches_horizontal_facing_and_eye_property() {
        ...
        assert_eq!(BlockEndPortalFrame::modelVariant(state), "eye=true,facing=west");
    }
    ...
    fn collision_adds_eye_but_selection_remains_frame_height() {
        ...
        assert_eq!(BlockEndPortalFrame::getCollisionBoxes(empty), vec![BlockEndPortalFrame::AABB_BLOCK]);
    ...
    fn placement_faces_opposite_the_player() {
        ...
        assert_eq!(BlockEndPortalFrame::onBlockPlacedState(&player).getMetadata(), 2);
    }
}
